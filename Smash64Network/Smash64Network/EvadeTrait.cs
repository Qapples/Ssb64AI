...
namespace Smash64Network
{
    ...
    public enum Evade
    {
        None, Left, Right, RollLeft, RollRight, Jump
    }
    ...
    public enum States
    {
        Damaged = 0x2C, Running = 0x11,
        UpAir = 0xD4, DownAir = 0xD5, BackAir = 0xD3, FowardAir = 0xD2, NeutralAir = 0xD1,
        FowardSmash = 0xCC, DownSmash = 0xD0, UpSmash = 0xCF,
        DownTilt = 0xC9, UpTilt = 0xC7, FowardTilt = 0xC3,
        Shield = 0x99, Crouching, DashAttack = 0x1D, Grabbing = 0xA8
    }
}
